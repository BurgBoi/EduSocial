...
public class StudentMenuController implements Initializable {
	...
	public static VBox studentResources;
	public static WebView studentWebViewer;
	public static Map<String, String> loadedStudentClasses = new HashMap<>();
					...
					for (int i = 0; i < classes.size(); i++) {
						...
						button.setOnMouseClicked(event -> {
							...
							try {
								...
								request.put("uuid", loadedStudentClasses.get(event.getButton().name()));
						...
						loadedStudentClasses.put((String) classData.get("name"), (String) classData.get("uuid"));
					}
				}
